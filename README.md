...
You can execute following command or as you prefer [download zip here](https://github.com/leandrocgsi/simple-rest-example-swagger/archive/master.zip) and import in your favourite IDE.
